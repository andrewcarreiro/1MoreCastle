module.exports = function(grunt){
	...
	grunt.registerTask('dev',['less:dev', 'concat:dev', 'copy:php','copy:images','copy:fonts']);
	grunt.registerTask('deploy',['less:deploy','uglify:prod', 'copy:php','copy:images','copy:fonts']);
